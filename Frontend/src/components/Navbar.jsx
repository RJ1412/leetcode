...
const Navbar = () => {
  ...
  return (
    <nav className="w-full sticky top-0 z-50 py-5">
      <div className="flex w-full justify-between mx-auto max-w-4xl bg-black/15 shadow-lg shadow-neutral-600/5 backdrop-blur-lg border border-gray-200/10 p-4 rounded-2xl">
        ...
        <div className="flex items-center gap-8">
          <div className="dropdown dropdown-end">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content mt-3 z-[50] p-2 shadow bg-base-100 bg-opacity-95 rounded-box w-52 space-y-3"
            >
              <li>
              ...
              <li>
                <LogoutButton className="hover:bg-primary hover:text-white text-base font-semibold flex items-center">
